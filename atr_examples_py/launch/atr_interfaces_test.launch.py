...
def generate_launch_description():
    ...
    # ATR Formation List Server
    nodes_json = os.path.join(
        get_package_share_directory('atr_examples_py'),
        'config',
        'nodes_Volvo.json'
    )

    node_publisher = Node(package='atr_examples_py',
                     name='node_marker_publisher',
    ...
    scheduler_app = Node(package='atr_examples_py',
                     name='scheduler_node',
