...
submodules= 'atr_examples_py/VRP'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'comsat = atr_examples_py.comsat_service:main',
            'scheduler=atr_examples_py.ATRScheduler:main',
            'node_publisher=atr_examples_py.ATRNodePublisher:main'
        ],
    },
)
